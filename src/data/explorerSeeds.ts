...
export const defaultExplorerSeeds: MissionExplorerEntry[] = [
  // --- 1. UNISFA (Abyei) ---
  {
    ...
    sourceUrl: 'https://peacekeeping.un.org/en/where-we-operate',
  ...
  // --- 4. UNTMIS (Somalia) ---
  {
    ...
    sourceUrl: 'https://dppa.un.org/en/factsheet/untmis-somalia',
  ...
  // --- 5. BINUH (Haiti) ---
  {
    ...
    sourceDate: '2023',
    profileLastReviewed: null,
    sourceUrl: 'https://dppa.un.org/en/factsheet/binuh-haiti',
