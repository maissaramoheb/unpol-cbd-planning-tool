...
export const defaultPestelsData: Record<string, PestelsItem> = {
  political: {
    ...
    finding: '[VERIFY] Assess whether command authority, political backing, or governance arrangements affect police reform sequencing.',
  ...
  economic: {
    ...
    finding: '[VERIFY] Assess whether resourcing, logistics, payroll, procurement, or administrative constraints affect continuity and integrity.',
  ...
  social: {
    ...
    finding: '[VERIFY] Examine how public trust, inclusion, identity dynamics, and service access affect police legitimacy and reporting.',
  ...
  technological: {
    ...
    finding: '[VERIFY] Assess whether records, reporting, communications, or information systems support administration and accountability.',
  ...
  environmental: {
    ...
    finding: '[VERIFY] Identify whether geography, climate, mobility, or infrastructure constraints affect police service delivery.',
    ...
    rating: { impact: 3, urgency: 2, confidence: 2, relevance: 3 }
  },
  legal: {
    id: 'legal',
    ...
    finding: '[VERIFY] Review whether laws, policies, mandates, and oversight pathways provide coherent operational guidance.',
  ...
  security: {
    ...
    finding: '[VERIFY] Assess current conflict, crime, public-order, and physical-security pressures affecting police operations.',
