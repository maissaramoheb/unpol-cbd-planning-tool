...
`;
  ...
  return `# UNPOL CBD Integrated Planning Brief
**Country / Mission Context**: ${profile.countryName}
**Generated Date**: ${new Date().toLocaleDateString()}
**Analyst**: ${profile.analystName || 'UNPOL Advisory Team'}
...
| Attribute | Detail |
| :--- | :--- |
| **Mission Name / Type** | ${profile.missionName} |
| **Region / Area of Operations** | ${profile.region} |
...
## 9. Disclaimer
> [!WARNING]
> **Educational & Planning Support Disclaimer**
> This brief is generated by the UNPOL CBD Integrated Planning Tool for educational and planning support purposes. It does **not** constitute official United Nations doctrine, operational policy, or formal mandate guidance. It does not replace the UN Human Rights Due Diligence Policy (HRDDP), host-state statutory law, or formal military/police command approval processes. All data and analysis must be verified by qualified mission analysts using active, official, and current sources. Sensitive, classified, or restricted operational data should not be entered into public web deployments of this tool.
`;
}
