  ...
  return (
    <article className="priority-package">
      ...
      <div className="priority-meta">
        ...
        <div><strong>Strategic Synthesis Basis</strong><p>{priority.strategicOptions.map(option => option.reference).join(' · ') || 'No Strategic Option linked'}</p></div>
      </div>
      <div className="priority-meta"><div><strong>Evidence confidence</strong><p>{inputs.confidenceLevel}/5</p></div></div>
